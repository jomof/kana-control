...
suite('kana-control-logic', () => {
  ...
  suite('parseEnglishString', () => {
    ...
    test('parses string with apostrophe', () => {
      const result = parseEnglishString("I can't speak Japanese");
      assert.deepEqual(result, [
        { englishWord: 'I', furigana: '' },
        { englishWord: "can't", furigana: '' },
        { englishWord: 'speak', furigana: '' },
        { englishWord: 'Japanese', furigana: '' },
      ]);
    });
  });
});
